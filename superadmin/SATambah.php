...
<html lang="en">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li><a href="HomeAdmin.php" aria-controls="home" role="tab" data-toggle="tab">Daftar Admin</a></li>
    <li class="active"><a href="SATambah.php" aria-controls="profile" role="tab" data-toggle="tab">Tambah Admin</a></li>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane active" id="profile">
    	<form action="do-registeradmin.php" method="POST">
  			<div class="field">
