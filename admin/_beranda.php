...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="beranda.php"><i class="icon-home"></i><span class="glyphicon glyphicon-search" aria-hidden="true">Beranda</span> </a> </li>
...
<table class="table table-bordered">
    ...
    ?>
        <tr>
			...
			<td><?php if ($data['Stats']=='0'){ ?> <a href="rubah_status.php?id=<?php echo $data['User_ID'] ;?>">rubah lunas</a><?php ;} ?></td>
