      ...
      <div class="row">
        <div class="span6">
          <div class="widget widget-nopad">
            <div class="widget-header"> <i class="icon-time"></i>
              <h3> Jadwal <?php echo $tanggal." ".ucfirst($bulan2)." ".$tahun; ?> | Lapangan <?php echo $field;?></h3>
            </div>
            <!-- /widget-header -->
		...
		<?php		$i++; $selisih--;	
				...
				<tr><td style="text-align: center"><?php echo $i.".00"; ?></td>
					...
					<td style="text-align: center"><a href="booking.php?jam=<?php echo $i; ?>&date=<?php echo $date; ?>&field=<?php echo $field; ?>">
